...
abstract class Connection
{
    ...
    public function getBuilder()
    {
        if (!empty($this->builder)) {
            ...
            return $this->getConfig('builder') ?: ucfirst($this->getConfig('type'));
        }
    }
    ...
    protected function bindParam($bind)
    {
        foreach ($bind as $key => $val) {
            ...
            if (!$result) {
                ...
                $message = "Error occurred  when binding parameters '{$param}'";
                throw new BindParamException($message, $this->config, $this->getLastsql(), $bind);
            }
        }
    }
